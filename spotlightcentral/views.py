...
def favicon(request):
    return HttpResponse(status=204)  # Respond with no content for favicon requests
...
def post_share(request, post_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            sent = True
            return render(request, 'spotlightcentral/post/share.html', {'post': post, 'form': form, 'sent': True})
        else:
            return render(request, 'spotlightcentral/post/share.html', {'post': post, 'form': form})
    else:
        form = EmailPostForm()
        return render(request, 'spotlightcentral/post/share.html', {'post': post, 'form': form})
